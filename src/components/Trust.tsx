...
const items = [
  ...
  },
  {
    ...
    description: "No subscriptions. Top up credits from $1. 200 free credits when you sign up.",
  },
];
    ...
    <section id="safety" className="relative py-20 px-6 bg-background">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="rounded-2xl border border-card-border bg-cream p-8 md:p-12"
        >
          {/* Header */}
          <div className="text-center mb-10">
            <h2 className="instrument-serif text-2xl md:text-3xl text-foreground">
              Built on trust
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {items.map((item, i) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-white border border-card-border flex items-center justify-center mx-auto mb-3 text-[#3A9C75]">
                  {item.icon}
                </div>
          ...
          {/* Disclaimer */}
          <p className="text-[11px] text-muted/60 text-center mt-10 max-w-xl mx-auto leading-relaxed">
