  ...
  return (
    <section id="download" className="relative py-28 px-6 bg-background">
      ...
      >
        ...
        <p className="text-muted text-sm md:text-base mt-4 leading-relaxed max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-10">
          ...
          <a
            href="#"
            className="flex items-center gap-3 px-6 py-3.5 rounded-full bg-foreground text-background hover:bg-accent-hover transition-all"
          >
